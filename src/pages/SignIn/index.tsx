...
import { Login } from '../../redux/action/Login.tsx';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import { SendEmailVerify, VerifyAccount } from '../../redux/action/Verify.tsx';
const SignIn = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            dispatch(Login(JSON.stringify(values, null, 2), () => navigate("/")))
        },
    });
    const verify = () => {
        const emailJSON = {
        ...
        dispatch(SendEmailVerify(JSON.stringify(emailJSON), () => navigate("/verify")))
        return ""
    ...
    return (
        <section className="section signup-area signin-area">
            {signinError?.code === 403 ? verify() : signinError && 
                <div style={{ position: "absolute", left: 0, top: 0, right: 0 }} className="alert alert-danger alert-dismissible fade show">
                ...
                <div className="row align-items-center">
                    <div className="col-xl-5 order-2 order-xl-0">
                        <div className="signup-area-textwrapper">
                            <h2 className="font-title--md mb-0">Sign in</h2>
                            <p className="mt-2 mb-lg-4 mb-3">Don't have account? <a href="/signup" className="text-black-50">Sign up</a></p>
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="form-element active">
                                    <div className="d-flex justify-content-between">
                                        <label htmlFor="confirm-password">Password</label>
                                        <a href="forget-password.html" className="text-primary fs-6">Forget Password</a>
                                    </div>
                                    <div className="form-alert-input">
                                ...
                                <div className="form-element d-flex align-items-center terms">
                                    <input className="checkbox-primary me-1" type="checkbox" id="agree" />
                                    <label htmlFor="agree" className="text-secondary mb-0 fs-6">Remember me</label>
                                </div>
                                <div className="form-element">
                                    <button type="submit" className="button button-lg button--primary w-100">Sign in</button>
                                </div>
                                <span className="d-block text-center text-secondary">or sign in with</span>
                                <div className="d-flex align-items-center flex-wrap mt-3 signinButtons">
                                    <a href="#" className="d-flex text-secondary align-items-center justify-content-center signup-with border fb rounded-1">
                                    ...
                                    <a href="#" className="d-flex text-secondary align-items-center justify-content-center signup-with border google rounded-1">
                                    ...
                                    <a href="#" className="d-flex text-secondary align-items-center justify-content-center signup-with border twitter rounded-1">
                                        <svg className="me-2" width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div className="col-xl-7 order-1 order-xl-0">
                        <div className="signup-area-image">
                            <img src={illustration} alt="Illustration Image" className="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
