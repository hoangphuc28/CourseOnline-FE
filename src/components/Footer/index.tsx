...
import footerLogo from  "../../assests/images/logo/footerlogo.png";
const Footer = () => {
    return (
        <Fragment>
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="footer__wrapper">
                            <div className="footer__wrapper_logo">
                            ...
                            <div className="footer__wrapper_social d-none d-lg-block">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div className="col-12 d-block d-lg-none">
                        <div className="footer__wrapper_social d-flex my-4">
                            <ul>
                                <li>
                                    <a href="#">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="footer__bottom">
                <div className="container">
                    <div className="footer__bottom-content">
                        ...
                        <div className="footer__bottom_topbutton">
                            <a href="#">
                                Go To Top
